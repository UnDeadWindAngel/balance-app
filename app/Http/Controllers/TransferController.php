    ...
    public function store(Request $request): JsonResponse
    {
        ...
        try {
            $transactions = $this->balanceService->transfer(
                $validatedData['from_user_id'],
                $validatedData['to_user_id'],
                $validatedData['amount'],
                $validatedData['comment'] ?? ''
            );

            $fromBalance = $this->balanceService->getBalance($validatedData['from_user_id']);
            $toBalance = $this->balanceService->getBalance($validatedData['to_user_id']);
